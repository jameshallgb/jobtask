                ...
                <div class="d-flex flex-column flex-md-row align-items-start h-md-100">
                    ...
                    <?php
                        ...
                        if( !empty( $hero_image ) ): ?>
                            ...
                            <img class="position-absolute" style="right: -15px; bottom: 0; min-width: 65vw; max-width: 100vw; min-height: 100%;" src="<?php echo esc_url( $hero['hero_image']['url'] ); ?>" alt="<?php echo esc_attr( $hero['hero_image']['alt'] ); ?>" />
